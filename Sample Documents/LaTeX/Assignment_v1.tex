...
RQ1: What types of data sources and digital engagement features are used in machine learning based dropout prediction?

RQ2: Which machine learning algorithms are most commonly applied?

RQ3: How is prediction performance evaluated, and which evaluation metrics are most frequently reported?

\textbf{4.2 Search Strategy and Selection Criteria}
...
\textbf{5.1 Data Sources and Digital Engagement Features}

Learning management system logs are the most common data source, followed by student information systems.

\textbf{5.2 Machine Learning Algorithms}

Random forests and logistic regression are the most frequently applied algorithms, with neural approaches gaining ground.

\textbf{5.3 Evaluation Metrics and Performance}

Model quality is most frequently reported using accuracy, precision, recall, and the F1-score.
